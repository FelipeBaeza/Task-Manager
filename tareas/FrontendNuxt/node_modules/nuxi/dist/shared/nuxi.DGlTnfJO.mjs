import { r as readPackageJSON } from './nuxi.CDtHTpB4.mjs';
...
import { j as join, r as resolve$1, n as normalize$1 } from './nuxi.Do0aYBCO.mjs';
...
async function dedupeDependencies(options = {}) {
  ...
  if (recreateLockfile) {
    ...
    for (const lockfile of lockfiles) {
      if (lockfile)
        fs.rmSync(resolve$1(resolvedOptions.cwd, lockfile), { force: true });
    }
