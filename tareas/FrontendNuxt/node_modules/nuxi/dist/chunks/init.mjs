import fs__default, { existsSync, readdirSync, renameSync, createWriteStream } from 'node:fs';
import process$1 from 'node:process';
import { d as defineCommand, l as logLevelArgs, c as cwdArgs, R as R$2, a as logger, i as colors, r as runCommand } from '../shared/nuxi.BlFGnQYG.mjs';
import 'node:tty';
import { $ as $fetch } from '../shared/nuxi.BzZJv2UC.mjs';
import { x as ve } from './main.mjs';
import { r as resolve, d as dirname, a as relative, b as basename, j as join } from '../shared/nuxi.Do0aYBCO.mjs';
...
import ie, { pipeline } from 'node:stream';
import { spawnSync } from 'node:child_process';
import { homedir, tmpdir } from 'node:os';
import require$$8, { promisify } from 'node:util';
import ft$1 from 'node:http';
import https from 'node:https';
import require$$9 from 'node:url';
import assert from 'node:assert';
import require$$11 from 'node:net';
import require$$6 from 'node:buffer';
import require$$15 from 'node:querystring';
import EventEmitter from 'node:events';
import require$$17 from 'node:diagnostics_channel';
import { c as commonjsGlobal$1 } from '../shared/nuxi.D5KtpA0t.mjs';
import require$$19 from 'node:tls';
import Ye from 'node:zlib';
import require$$11$1 from 'node:perf_hooks';
import require$$22 from 'node:util/types';
import require$$23 from 'node:worker_threads';
import require$$24 from 'node:async_hooks';
import require$$25 from 'node:console';
import require$$26 from 'node:dns';
import require$$28 from 'net';
import require$$2 from 'http';
import require$$1 from 'https';
import require$$31 from 'tls';
import require$$6$1 from 'tty';
import require$$3 from 'os';
import require$$7 from 'url';
import path from 'node:path';
import { i as installDependencies } from '../shared/nuxi.DGlTnfJO.mjs';

var proxy = {};

var nodeFetchNative_DhEqb06g = {};

var hasRequiredNodeFetchNative_DhEqb06g;

function requireNodeFetchNative_DhEqb06g () {
	if (hasRequiredNodeFetchNative_DhEqb06g) return nodeFetchNative_DhEqb06g;
	hasRequiredNodeFetchNative_DhEqb06g = 1;
var l=Object.defineProperty;var o=(e,t)=>l(e,"name",{value:t,configurable:true});var commonjsGlobal=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof commonjsGlobal$1<"u"?commonjsGlobal$1:typeof self<"u"?self:{};function getDefaultExportFromCjs(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}o(getDefaultExportFromCjs,"getDefaultExportFromCjs"),nodeFetchNative_DhEqb06g.commonjsGlobal=commonjsGlobal,nodeFetchNative_DhEqb06g.getDefaultExportFromCjs=getDefaultExportFromCjs;
	return nodeFetchNative_DhEqb06g;
}
...
`),"normalizeLinefeeds"),lA=[],YA=new Uint8Array([13,10]);pA=0;let nA=false;for(const[sA,BA]of Z)if(typeof BA=="string"){const dA=V.encode(UA+`; name="${QA(eA(sA))}"\r
\r
${eA(BA)}\r
...
var s$2,n$1;function a$3(){if(n$1)return s$2;n$1=1;const i=fs,e=(process.env.__TESTING_MKDIRP_NODE_VERSION__||process.version).replace(/^v/,"").split("."),t=+e[0]>10||+e[0]==10&&+e[1]>=12;return s$2={useNative:t?r=>r.mkdir===i.mkdir:()=>false,useNativeSync:t?r=>r.mkdirSync===i.mkdirSync:()=>false},s$2}
...
export { requireNodeFetchNative_DhEqb06g as a, init$1 as i, requireNode as r };
