...
import { lstat, stat, readdir, realpath, readFile } from 'node:fs/promises';
...
import { c as createJiti, l as loadKit } from '../shared/nuxi.BxIDvNqq.mjs';
import { l as listen } from './index2.mjs';
import { p as p$1, a as logger } from '../shared/nuxi.BlFGnQYG.mjs';
import { j as joinURL } from '../shared/nuxi.QWnQy_ku.mjs';
import { a as clearBuildDir } from '../shared/nuxi.DMVYux0z.mjs';
import { l as loadNuxtManifest, r as resolveNuxtManifest, w as writeNuxtManifest } from '../shared/nuxi.BNSB4fGG.mjs';
import { inspect, debuglog } from 'node:util';
import os from 'node:os';
import tty__default from 'node:tty';
import { g as getDefaultExportFromCjs } from '../shared/nuxi.D5KtpA0t.mjs';
import { fileURLToPath } from 'node:url';
import { r as resolve$1, j as join$1, a as relative$1 } from '../shared/nuxi.Do0aYBCO.mjs';
...
var ErrorMetadata = class extends BaseComponent {
  ...
  #formatRowValue(value, dumpValue, cspNonce) {
    ...
    return dump$1(value, { styles: themes$1.cssVariables });
  }
  /**
...
class NuxtDevServer extends EventEmitter$1 {
  ...
  async _load(reload, reason) {
    ...
    this._distWatcher = chokidar.watch(resolve$1(this._currentNuxt.options.buildDir, "dist"), {
      ignoreInitial: true,
      depth: 0
    });
  ...
  async _watchConfig() {
    const configWatcher = chokidar.watch([this.options.cwd, join$1(this.options.cwd, ".config")], {
      ignoreInitial: true,
      depth: 0
    });
