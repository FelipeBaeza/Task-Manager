...
import { d as defineCommand, e as legacyRootDirArgs, l as logLevelArgs, c as cwdArgs, a as logger, i as colors } from '../shared/nuxi.BlFGnQYG.mjs';
import 'node:tty';
import { r as readPackageJSON } from '../shared/nuxi.CDtHTpB4.mjs';
import { l as loadKit } from '../shared/nuxi.BxIDvNqq.mjs';
import { c as cleanupNuxtDirs, n as nuxtVersionToGitIdentifier } from '../shared/nuxi.BNSB4fGG.mjs';
import { g as getPackageManagerVersion } from '../shared/nuxi.BSm0_9Hr.mjs';
import { r as resolve } from '../shared/nuxi.Do0aYBCO.mjs';
import { d as detectPackageManager, a as addDependency, b as dedupeDependencies } from '../shared/nuxi.DGlTnfJO.mjs';
import 'node:crypto';
import 'node:path';
import 'node:util';
import 'node:url';
